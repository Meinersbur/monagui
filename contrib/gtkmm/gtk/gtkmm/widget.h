...
/* QUEUE DRAWS */
   ...
   * 
   * If @a clip_rect is non-<tt>0</tt>, the resulting pixmap is shrunken to
   ...
   * 
   * The returned pixmap can be <tt>0</tt>, if the resulting @a clip_area was empty.
   * @param clip_rect A Gdk::Rectangle or <tt>0</tt>.
