...
#ifndef _GTKSOURCEVIEWMM_SOURCECOMPLETIONCONTEXT_H
#define _GTKSOURCEVIEWMM_SOURCECOMPLETIONCONTEXT_H
...
namespace Gsv
{ class SourceCompletionContext_Class; } // namespace Gsv
namespace Gsv
{
...
public:
  typedef SourceCompletionContext CppObjectType;
  typedef SourceCompletionContext_Class CppClassType;
  typedef GtkSourceCompletionContext BaseObjectType;
  typedef GtkSourceCompletionContextClass BaseClassType;

private:  friend class SourceCompletionContext_Class;
  static CppClassType sourcecompletioncontext_class_;

private:
  // noncopyable
  SourceCompletionContext(const SourceCompletionContext&);
  SourceCompletionContext& operator=(const SourceCompletionContext&);

protected:
  explicit SourceCompletionContext(const Glib::ConstructParams& construct_params);
  explicit SourceCompletionContext(GtkSourceCompletionContext* castitem);
...
public:
   ...
   * @newin{2,10}
   */
  void add_proposals(const Glib::RefPtr<SourceCompletionProvider>& provider, const std::vector<Glib::RefPtr<SourceCompletionProposal> >& proposals, bool finished);
...
namespace Glib
{
   ...
   *
   * @relates Gsv::SourceCompletionContext
   */
  Glib::RefPtr<Gsv::SourceCompletionContext> wrap(GtkSourceCompletionContext* object, bool take_copy = false);
}


#endif /* _GTKSOURCEVIEWMM_SOURCECOMPLETIONCONTEXT_H */
