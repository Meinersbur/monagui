...
#ifndef _GTKSOURCEVIEWMM_SOURCECOMPLETIONITEM_H
#define _GTKSOURCEVIEWMM_SOURCECOMPLETIONITEM_H
...
namespace Gsv
{ class SourceCompletionItem_Class; } // namespace Gsv
namespace Gsv
{
...
:
  public Glib::Object,
  public SourceCompletionProposal
{
  
#ifndef DOXYGEN_SHOULD_SKIP_THIS

public:
  typedef SourceCompletionItem CppObjectType;
  typedef SourceCompletionItem_Class CppClassType;
  typedef GtkSourceCompletionItem BaseObjectType;
  typedef GtkSourceCompletionItemClass BaseClassType;

private:  friend class SourceCompletionItem_Class;
  static CppClassType sourcecompletionitem_class_;

private:
  // noncopyable
  SourceCompletionItem(const SourceCompletionItem&);
  SourceCompletionItem& operator=(const SourceCompletionItem&);

protected:
  explicit SourceCompletionItem(const Glib::ConstructParams& construct_params);
  explicit SourceCompletionItem(GtkSourceCompletionItem* castitem);
...
namespace Glib
{
   ...
   *
   * @relates Gsv::SourceCompletionItem
   */
  Glib::RefPtr<Gsv::SourceCompletionItem> wrap(GtkSourceCompletionItem* object, bool take_copy = false);
}


#endif /* _GTKSOURCEVIEWMM_SOURCECOMPLETIONITEM_H */
