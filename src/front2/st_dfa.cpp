...
DFA*
st_dfa_restrict(DFA *a, const Pos &p)
{
  Timer temp;
...
DFA*
st_dfa_negation(DFA *a, const Pos &p)
{
  Timer temp;
...
DFA*
st_dfa_product(DFA *a1, DFA *a2, dfaProductType ff, const Pos &p)
{
  Timer temp;
...
DFA*
st_dfa_project(DFA *a, Ident i, const Pos &p, bool quotient)
{
  Timer temp1, temp2;
...
st_dfa_minimization(DFA *a)
{
  ...
  if (options.intermediate)
    mona_dfaPrintVerbose(cout, result);
...
DFA*
st_dfa_prefix(DFA *a, const Pos &p)
{
  Timer temp;
