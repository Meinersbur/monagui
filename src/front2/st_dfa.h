#ifndef HEADER_9A21C74F6F377102
#define HEADER_9A21C74F6F377102
...
DFA *st_dfa_restrict(DFA *a, const Pos &p);
DFA *st_dfa_negation(DFA *a, const Pos &p);
DFA *st_dfa_product(DFA *a1, DFA *a2, dfaProductType ff, const Pos &p);
DFA *st_dfa_project(DFA *a, Ident i, const Pos &p, bool quotient = true);
...
DFA *st_dfa_prefix(DFA *a, const Pos &p);
