...
GTA *
st_gta_restrict(GTA *g, const Pos &p)
{
  Timer temp;
...
GTA *
st_gta_negation(GTA *g, const Pos &p)
{
  Timer temp;
...
GTA *
st_gta_product(GTA *g1, GTA *g2, gtaProductType ff, const Pos &p)
{
  Timer temp;
...
GTA *
st_gta_project(GTA *g, Ident i, const Pos &p, bool quotient)
{
  Timer temp;
...
st_gta_minimization(GTA *g)
{
  ...
  if (options.intermediate)
    mona_gtaPrintVerbose(cout, result);
