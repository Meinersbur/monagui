#ifndef HEADER_B1000FB389F2CDAE
#define HEADER_B1000FB389F2CDAE
...
GTA *st_gta_restrict(GTA *g, const Pos &p);
GTA *st_gta_negation(GTA *g, const Pos &p);
GTA *st_gta_product(GTA *g1, GTA *g2, gtaProductType ff, const Pos &p);
GTA *st_gta_project(GTA *a, Ident i, const Pos &p, bool quotient = true);
